...
func (_c *ReactionCreate) SetUserID(id uuid.UUID) *ReactionCreate {
...
func (_c *ReactionCreate) SetPostID(id uuid.UUID) *ReactionCreate {
	_c.mutation.SetPostID(id)
	return _c
}

// SetPost sets the "post" edge to the Post entity.
func (_c *ReactionCreate) SetPost(v *Post) *ReactionCreate {
...
func (_c *ReactionCreate) check() error {
	...
	if len(_c.mutation.PostIDs()) == 0 {
		return &ValidationError{Name: "post", err: errors.New(`ent: missing required edge "Reaction.post"`)}
	}
	return nil
}
