...
func (_c *PostCreate) SetUserID(id uuid.UUID) *PostCreate {
...
func (_c *PostCreate) SetGoal(v *Goal) *PostCreate {
	return _c.SetGoalID(v.ID)
}

// AddImageIDs adds the "images" edge to the Image entity by IDs.
func (_c *PostCreate) AddImageIDs(ids ...uuid.UUID) *PostCreate {
...
func (_c *PostCreate) AddReactionIDs(ids ...uuid.UUID) *PostCreate {
	_c.mutation.AddReactionIDs(ids...)
	return _c
}

// AddReactions adds the "reactions" edges to the Reaction entity.
func (_c *PostCreate) AddReactions(v ...*Reaction) *PostCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
